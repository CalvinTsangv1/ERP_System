...
@section('content')
    ...
    {!! Form::open(['action' =>'AgreementHeaderController@storeWithDetails', 'method'=> 'POST','files'=>true , 'style'=>'width:1000px;'])!!}
        ...
        <div class="row">
            ...
            <div class="col-4">     {{ Form::select('tentativeSchedule',  array('Daily'=>'Daily', 'Weekly'=>'Weekly', 'Monthly'=>'Monthly', 'Bi-monthly'=>'Bi-monthly', 'Quarterly'=>'Quarterly', 'Half-yearly'=>'Half-yearly') , null, array('class' =>'form-control')) }}</div>
        </div>
        <div class="row">
            <div class="col-4 text-right"> {{ Form::label('deliveryAddress', 'Delivery Address') }}</div>
            <div class="col-4">       {{ Form::text('deliveryAddress',   App\Http\Controllers\BranchController::getBranchName(4)->address , array('class' =>'form-control')) }}</div>
        </div>
        </br>
                ...
                <table class="table" id="items_table">
                    ...
                    <tbody>
                        <tr id="item0">
                            ...
                            <td><input type="number" name="priceBreak[]" class="form-control" max="1" step="0.05" min="0.00" /></td> <!-- Please modify -->
