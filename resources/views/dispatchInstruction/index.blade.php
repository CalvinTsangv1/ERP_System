    ...
    <table class="table table-striped table-bordered">
       ...
       <tbody>
            ...
            <tr>
                ...
                <td style="text-align:center"><a class="btn btn-small btn-outline-success" href="{{route('dispatchInstruction.showDetails',$value->diNo)}}" style="display:inline"><i class="fas fa-eye"></i></a>
           </td>
            </tr>
            @endforeach
        </tbody>
